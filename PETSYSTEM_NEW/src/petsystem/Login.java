...
public class Login extends javax.swing.JFrame {
    ...
    private void jButton1_loginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1_loginActionPerformed
		...
		PreparedStatement ps = MyConnection.GetConnection().prepareStatement("SELECT  user_name, password FROM USER WHERE user_name=? AND password=?");//NEED TO CONNECT TO THE DATABASE.check the user name and password
